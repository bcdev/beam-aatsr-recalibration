...
public class RecalibrateAATSRReflectancesAction extends AbstractVisatAction {
    ...
    public void actionPerformed(CommandEvent commandEvent) {
        final RecalibrateAATSRReflectancesDialog dialog =
                new RecalibrateAATSRReflectancesDialog(OperatorSpi.getOperatorAlias(RecalibrateAATSRReflectancesOp.class),
                        getAppContext(),
                        "AATSR Reflectance Recalibration",
                        "aatsrRecalibration", "_RECALIBRATED");
