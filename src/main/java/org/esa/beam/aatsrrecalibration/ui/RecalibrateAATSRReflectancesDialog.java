...
public class RecalibrateAATSRReflectancesDialog extends SingleTargetProductDialog {
     ...
     * @param targetProductNameSuffix the suffix appended to the source product name, in order to build
     *                                the target product name
     */
    public RecalibrateAATSRReflectancesDialog(String operatorName, AppContext appContext, String title, String helpID,
